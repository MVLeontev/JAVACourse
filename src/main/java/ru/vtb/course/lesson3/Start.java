// для запуска очистки кэша используется класс Timer. Задание на очистку создается в конструкторе InvocationHandler и стартует через 1000 мс с интервалом 1000 мс
